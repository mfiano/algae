...
(u:defun-inline make-state (table x y z)
...
(u:defun-inline extrapolate (table xsb ysb zsb dx dy dz)
  (let ((index (c:pget table zsb ysb xsb)))
...
(defmethod c::%make-sampler-func ((type (eql :open-simplex-3d)))
